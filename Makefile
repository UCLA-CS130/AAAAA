...
request_handler.o: request_handler.h request_handler.cpp
	g++ -c request_handler.cpp $(LDFLAGS) $(CXXFLAGS)

reply.o: reply.h reply.cpp
	g++ -c reply.cpp $(LDFLAGS) $(CXXFLAGS)

mime_types.o: mime_types.h mime_types.cpp
	g++ -c mime_types.cpp $(LDFLAGS) $(CXXFLAGS)
